...
class network(tnn.Module):
    ...
    def __init__(self):
        ...
        self.lstm1 = tnn.LSTM(50, 100, num_layers=3, batch_first=True, dropout=0.5)
        self.lstm2 = tnn.LSTM(50, 200, num_layers=2, batch_first=True, dropout=0.5)
        self.Linear1 = tnn.Linear(200, 128)
        self.Relu = tnn.ReLU()
        self.Linear2 = tnn.Linear(128, 70)
    ...
    def forward(self, input, length):
        shape = input.shape[0]
        out, (h_n, c_n) = self.lstm1(input)
        a = out[torch.arange(shape),length-1]
        shape = a.shape[0]
        print('1')
        out, (h_n, c_n) = self.lstm2(a)
        print('2')
